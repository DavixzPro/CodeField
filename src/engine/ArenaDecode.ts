export default class ArenaDecode {
    ...
    private drawFieldMarks(
        ...
        this.drawBottomLaunchZone(
            ctx,
            width,
            height
        );

        this.drawTopLaunchZone(
            ctx,
            width,
            height
        );

        this.drawHumanPlayerZones(
            ctx,
            width,
            height
        );

        this.drawParkingZones(
            ctx,
            width,
            height
        );

        this.drawArtifactMarks(
            ctx,
            width
        );

        this.drawArtifactRamps(
            ctx,
            width
        );
