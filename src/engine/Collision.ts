...
export default class Collision {
    ...
    // As duas bases horizontais do suporte do Hive
    ...
    // Espessura física da estrutura

    const thickness = 3;


    // =================================================
    // VERIFICA COLISÃO COM UMA RETA
    // =================================================

    const collidesWithStructure = (
        structureY: number
    ): boolean => {
    ...
    // =================================================
    // ESTRUTURA CINZA DE CIMA
    // =================================================

    if (
        collidesWithStructure(topY)
    ) {
    ...
    // =================================================
    // ESTRUTURA CINZA DE BAIXO
    // =================================================

    if (
        collidesWithStructure(bottomY)
    ) {
